...
<div align=center>幼麟游戏 让你的棋牌开发、运营更简单</div>
...
- 自建语音聊天系统  
 ...
 ---
- 幼麟棋牌在线文档(5.0) [等得花儿都谢了,安排](./docs_5_0/index.md)
- 幼麟棋牌报价单 [必须看，马上看](./docs/报价单.md)
- 幼麟棋牌最新版本功能列表 [等不及了，我要看](./docs_5_0/index.md)
- 幼麟棋牌开发环境及下载地址 [点击查看](./docs/开发环境.md)
- 幼麟棋牌版本更新机制 [点击查看](./docs/幼麟棋牌版本更新机制.md)
- 幼麟棋牌2.0版本热更新打包文档 [点击查看](./docs_2_0/热更新打包2.0版本.md)


[^_^]:

   注：文档建设中，部分链接可能暂时无效，敬请谅解！